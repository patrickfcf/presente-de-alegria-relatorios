...
export const publicPages = [
  { path: "/", title: "Presente de Alegria — Aplicativo da ONG", heading: "Alegria que aproxima.", description: "Seu espaço no Presente de Alegria: acesse Minha célula, acompanhe Eventos e Notícias e conheça as campanhas de Doação." },
  ...
  { path: "/ajudas", title: "Como ajudar: doações e campanhas | Presente de Alegria", heading: "Doação", description: "Conheça as campanhas de apoio do Presente de Alegria. Veja como contribuir com doações, arrecadações e outras iniciativas pelos canais oficiais." },
