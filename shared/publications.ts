...
export function eventContactUrl(
  value: string,
  ...
  const send =
    ...
    url.pathname === "/send" &&
    /^\d+$/.test(url.searchParams.get("phone") || "");
  ...
  url.searchParams.set(
    "text",
    `Olá! Vi o evento “${event.title}”, do dia ${date}, no aplicativo do Presente de Alegria e gostaria de saber mais informações sobre como participar. Pode me ajudar?`,
  );
  return url.toString();
}
